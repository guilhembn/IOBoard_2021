...
{
    //constexpr int32_t Stepper::vMaxMax = 300000;
    //constexpr uint32_t Stepper::aMax = 500000;
    ...
    {
        setDir(speed >= 0 ? 1 : -1);
        vMax = std::min(Stepper::vMaxMax, std::max(-Stepper::vMaxMax, speed));
        return *this;
    }
